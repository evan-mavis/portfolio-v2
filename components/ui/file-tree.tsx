  ...
  (
    ...
    return (
      <button
        ...
        disabled={!isSelectable}
        className={cn(
          "flex w-fit items-center gap-1 rounded-md pr-1 text-base duration-200 ease-in-out rtl:pr-0 rtl:pl-1 justify-start text-left",
          {
      ...
      >
        {fileIcon ?? (
          <FileIcon className="w-[1.25em] h-[1.25em] flex-shrink-0" />
        )}
